<%-- 
    Document   : 10minAbsWorkout
    Created on : Dec 12, 2016, 4:47:05 PM
    Author     : Rachel
--%>
...
<html>
    <head>
        ...
        <title>10 min abs workout</title>
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <%}%>          
        <div class="container">
            <h1>10 Min Abs Workout</h1>
            <p>So you want to have abs? Try this workout at home!</p>
            <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/1919eTCoESo?rel=0" allowfullscreen></iframe>
            </div>
            <p><i>Video source: FitnessBlender (https://www.youtube.com/watch?v=1919eTCoESo)</i></p>
        </div>
    </body>
</html>
